...
export const AST = {
    ExpressionStatement: Symbol.for('ExpressionStatement'),
    AssignmentExpression: Symbol.for('AssignmentExpression'),
    ConditionalExpression: Symbol.for('ConditionalExpression'),
    LogicalExpression: Symbol.for('LogicalExpression'),
    BinaryExpression: Symbol.for('BinaryExpression'),
    UnaryExpression: Symbol.for('UnaryExpression'),
    CallExpression: Symbol.for('CallExpression'),
    MemberExpression: Symbol.for('MemberExpression'),
