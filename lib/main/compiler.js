...
exports.Compiler = exports.AsyncExpression = exports.Expression = undefined;
...
const Expression = exports.Expression = expressionMixin(Function);
const AsyncExpression = exports.AsyncExpression = expressionMixin(AsyncFunction);

let Compiler = exports.Compiler = class Compiler {
    ...
    compile(source, watch) {
        const ast = new _parser.Parser(source).ast();
        if (watch) {
            this.watch = watch;
        }
        return {
